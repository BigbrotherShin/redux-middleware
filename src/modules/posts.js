...
export const getPosts = () => async dispatch => {
  ...
  try {
    ...
    dispatch({ type: GET_POSTS_SUCCESS, posts }); // success
  } catch (e) {
    dispatch({ type: GET_POSTS_ERROR, error: e }); // failure
  }
};
...
export const getPost = id => async dispatch => {
  ...
  try {
    ...
    dispatch({ type: GET_POST_SUCCESS, post }); // success
  } catch (e) {
    dispatch({ type: GET_POST_ERROR, error: e }); // failure
  }
};
...
// 이런 반복되는 코드는 따로 함수화하여 코드를 리팩토링하는 것이 좋은 자세
